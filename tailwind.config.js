  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        loadingAnimation: {
          "from, to": {
            backgroundImage: "url('../public/conuhackslogo_nobgv2-1.png')",
            transform: "scale(0.5)",
          },
          "12%": { transform: "scale(0.5) rotate(0deg)" },
          "21%, 32%": {
            backgroundImage: "url('../public/conuhackslogo_nobgv2-2.png')",
          },
          "23%, 27%": {
            backgroundImage: "url('../public/conuhackslogo_nobgv2-3.png')",
          },
          "18%, 39%": {
            backgroundImage: "url('../public/conuhackslogo_nobgv2-1.png')",
          },
