  ...
  return (
    <>
      <div className='flex flex-row max-h-screen h-screen max-w-screen w-screen bg-red-500 py-10 px-8 bg-stripes space-x-8'>
        <div className='flex flex-row w-full h-full bg-white rounded-lg border-8 border-white'>
          <div className='hidden'>
          <Components.Camera/>
          </div>
          <div className='w-full h-full bg-zig-zag flex flex-col items-center justify-around text-red-800 py-32 space-y-2 rounded-lg '>
            <div className=''>
